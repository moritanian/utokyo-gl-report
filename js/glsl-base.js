...
window.onload = function(){
     ...
     // 変数宣言
    var a, b, c, d, e, f, g, h, m, l, p, t, u, v, w, x, y, z, dbg, dbgOpt, gebt, vsFileName, fsFileName;

    vsFileName = "vertex.vs";
    fsFileName = "fragent.fs";
        ...
        */
        ...
        function addFile(i, j, l){
            ...
            function _highLightOneLine(line){
                ...
                return highLightWordsInLine(words, comment);
            }

            function highLightWordsInLine(words, comment){
            ...
            var vt = b('vertex-tab');
            var ft = b('fragment-tab');
            
            vt.addEventListener('click', function(){
                lE.style.display = i==1 ? 'none' : 'block';
                this.classList.add('active-tab');
                ft.classList.remove('active-tab');
            });
            
            ft.addEventListener('click', function(){
                lE.style.display = i == 0 ? 'none' : 'block';
                this.classList.add('active-tab');
                vt.classList.remove('active-tab');
            });
            ...
            // event set
            if(!dbgOpt.eventSetup){

                vt.textContent = vsFileName;
                ft.textContent = fsFileName;
